...
namespace CustomerRegistrationADO.Connect.Mssql.Centraldb
{
    public abstract class CentraldbBase
    {
        public static string conString { get; set; } // "Server=191.20.2.27;Uid=sa;PASSWORD=abc123;database=CRMDB;Max Pool Size=10;Connect Timeout=6000;";
